...
class MemberShip4 extends Component {
    ...
    render() {
        ...
        let data = [{
            ...
            'membershipname' : 'Family Membership',
            'contractend':'30/11/2019'
        ...
        dataTable = <div className="col-md-12"><BootstrapTable
            ...
            <TableHeaderColumn dataField='relation'>Relation</TableHeaderColumn>
            <TableHeaderColumn dataField='age'>Age</TableHeaderColumn>
            <TableHeaderColumn dataField='gender'>Gender</TableHeaderColumn>
            <TableHeaderColumn dataField='membershipstatus'>Membership Status</TableHeaderColumn>
            <TableHeaderColumn dataField='membershipname'>Membership Name</TableHeaderColumn>
            <TableHeaderColumn dataField='contractend'>Contract End</TableHeaderColumn>
        </BootstrapTable></div>
        ...
        {/* <Buttonscomponent
                    buttonFunction={() => this.props.next("5")}
                    btnType="button"
                    btnCalss="btn btn-default btnRight"
                    btnTitle="Next"
                />
                <Buttonscomponent
                    buttonFunction={() => this.props.back1("4")}
                    btnType="button"
                    btnCalss="btn btn-default btnRight"
                    btnTitle="Back"
                /> */}
        ...
        return (
          ...
          <div className="stepwizard-row">
            ...
            <div className="stepwizard-step">
              <button type="button" className="btn btn-primary btn-circle" style={circleCSS} onClick={() => this.props.presentScreen("4")}>Family</button>
              <p>Family</p>
            </div>
            <div className="stepwizard-step"> 
